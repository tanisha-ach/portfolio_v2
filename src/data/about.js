// Content for the About page, ported from the Paper design.

export const statement =
  "I'm a senior product designer who turns ambiguous, high-stakes problems into products people actually understand.";
...
export const stats = [
  ...
  { figure: "17M+", label: "users reached through\nshipped work" },
];
